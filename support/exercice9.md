...
```
shouldIncreaseScoreWhenFirstRollIsMadeInStandardFrame()
shouldIncreaseScoreWhenSecondRollIsMadeInStandardFrame()
shouldRejectSecondRollWhenStandardFrameStartsWithStrike()
shouldRejectThirdRollWhenStandardFrameAlreadyHasTwoRolls()
shouldIncreaseScoreWhenSecondRollIsMadeAfterStrikeInLastFrame()
shouldAcceptThirdRollWhenLastFrameStartsWithStrike()
shouldAcceptSecondRollWhenLastFrameStartsWithStrike()
shouldIncreaseScoreWhenThirdRollIsMadeAfterStrikeInLastFrame()
shouldAcceptThirdRollWhenLastFrameStartsWithSpare()
shouldIncreaseScoreWhenThirdRollIsMadeAfterSpareInLastFrame()
shouldRejectThirdRollWhenLastFrameHasNoStrikeOrSpare()
shouldRejectFourthRollInLastFrame()
```
